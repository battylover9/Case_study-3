...
resource "aws_instance" "monitoring" {
  ...
  vpc_security_group_ids      = [var.security_group_ids["monitoring"]]
  ...
  tags = {
    ...
    Type = "Monitoring"
    Requirement = "REQ-NCA-P2-05, REQ-NCA-P2-08, REQ-NCA-P2-09"
...
output "prometheus_url" {
  ...
  value       = "http://prometheus.${var.private_zone_name}:9090"
}
